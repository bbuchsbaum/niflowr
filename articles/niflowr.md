...
#>   [4] "afni.allineate_apply"                       
#>   [5] "afni.allineate_estimate"                    
#>   [6] "afni.allineate"                             
#>   [7] "afni.auto_tcorrelate"                       
#>   [8] "afni.auto_tlrc"                             
#>   [9] "afni.autobox"                               
#>  [10] "afni.automask"                              
#>  [11] "afni.axialize"                              
#>  [12] "afni.bandpass"                              
#>  [13] "afni.blur_in_mask"                          
#>  [14] "afni.blur_to_fwhm"                          
#>  [15] "afni.brick_stat"                            
#>  [16] "afni.bucket"                                
#>  [17] "afni.calc"                                  
#>  [18] "afni.cat_matvec"                            
...
#>  [20] "afni.center_mass"                           
#>  [21] "afni.clip_level"                            
#>  [22] "afni.convert_dset"                          
#>  [23] "afni.copy"                                  
#>  [24] "afni.deconvolve"                            
#>  [25] "afni.degree_centrality"                     
#>  [26] "afni.despike"                               
#>  [27] "afni.detrend"                               
#>  [28] "afni.dot"                                   
#>  [29] "afni.ecm"                                   
...
#>  [44] "afni.net_corr"                              
#>  [45] "afni.notes"                                 
#>  [46] "afni.nwarp_adjust"                          
#>  [47] "afni.nwarp_apply"                           
#>  [48] "afni.nwarp_cat"                             
#>  [49] "afni.one_d_tool_py"                         
#>  [50] "afni.outlier_count"                         
#>  [51] "afni.quality_index"                         
#>  [52] "afni.qwarp_plus_minus"                      
#>  [53] "afni.qwarp"                                 
#>  [54] "afni.re_ho"                                 
#>  [55] "afni.refit"                                 
#>  [56] "afni.remlfit"                               
...
#>  [81] "afni.zcat"                                  
#>  [82] "afni.zeropad"                               
#>  [83] "ants.affine_initializer"                    
#>  [84] "ants.ai"                                    
#>  [85] "ants.ants_introduction"                     
#>  [86] "ants.ants"                                  
#>  [87] "ants.apply_transforms_to_points"            
#>  [88] "ants.apply_transforms"                      
#>  [89] "ants.atropos"                               
#>  [90] "ants.average_affine_transform"              
#>  [91] "ants.average_images"                        
#>  [92] "ants.brain_extraction"                      
#>  [93] "ants.buildtemplateparallel"                 
#>  [94] "ants.compose_multi_transform"               
#>  [95] "ants.composite_transform_util"              
#>  [96] "ants.convert_scalar_image_to_rgb"           
#>  [97] "ants.cortical_thickness"                    
#>  [98] "ants.create_jacobian_determinant_image"     
#>  [99] "ants.create_tiled_mosaic"                   
#> [100] "ants.denoise_image"                         
#> [101] "ants.gen_warp_fields"                       
#> [102] "ants.image_math"                            
#> [103] "ants.joint_fusion"                          
#> [104] "ants.kelly_kapowski"                        
#> [105] "ants.label_geometry"                        
#> [106] "ants.laplacian_thickness"                   
#> [107] "ants.measure_image_similarity"              
#> [108] "ants.multiply_images"                       
#> [109] "ants.n4_bias_field_correction"              
#> [110] "ants.registration_syn_quick"                
#> [111] "ants.registration"                          
#> [112] "ants.resample_image_by_spacing"             
#> [113] "ants.threshold_image"                       
#> [114] "ants.transform_build"                       
#> [115] "ants.warp_image_multi_transform"            
#> [116] "ants.warp_time_series_image_multi_transform"
#> [117] "dcm2niix.convert"                           
#> [118] "fastsurfer.run"                             
#> [119] "fastsurfer.segment"                         
#> [120] "freesurfer.add_x_form_to_header"            
#> [121] "freesurfer.aparc2_aseg"                     
#> [122] "freesurfer.apas2_aseg"                      
#> [123] "freesurfer.apply_mask"                      
#> [124] "freesurfer.apply_vol_transform"             
#> [125] "freesurfer.bb_register"                     
#> [126] "freesurfer.binarize"                        
#> [127] "freesurfer.ca_label"                        
#> [128] "freesurfer.ca_normalize"                    
#> [129] "freesurfer.ca_register"                     
#> [130] "freesurfer.check_talairach_alignment"       
#> [131] "freesurfer.concatenate_lta"                 
#> [132] "freesurfer.concatenate"                     
#> [133] "freesurfer.contrast"                        
#> [134] "freesurfer.curvature_stats"                 
#> [135] "freesurfer.curvature"                       
#> [136] "freesurfer.dicom_convert"                   
#> [137] "freesurfer.edit_w_mwith_aseg"               
#> [138] "freesurfer.em_register"                     
#> [139] "freesurfer.euler_number"                    
#> [140] "freesurfer.extract_main_component"          
#> [141] "freesurfer.fit_ms_params"                   
#> [142] "freesurfer.fix_topology"                    
#> [143] "freesurfer.fuse_segmentations"              
#> [144] "freesurfer.glm_fit"                         
#> [145] "freesurfer.gtm_seg"                         
#> [146] "freesurfer.gtmpvc"                          
#> [147] "freesurfer.image_info"                      
#> [148] "freesurfer.jacobian"                        
#> [149] "freesurfer.label2_annot"                    
#> [150] "freesurfer.label2_label"                    
#> [151] "freesurfer.label2_vol"                      
#> [152] "freesurfer.logan"                           
#> [153] "freesurfer.lta_convert"                     
#> [154] "freesurfer.make_average_subject"            
#> [155] "freesurfer.make_surfaces"                   
#> [156] "freesurfer.mni_bias_correction"             
#> [157] "freesurfer.mp_rto_mni305"                   
#> [158] "freesurfer.mr_is_ca_label"                  
#> [159] "freesurfer.mr_is_calc"                      
#> [160] "freesurfer.mr_is_combine"                   
#> [161] "freesurfer.mr_is_convert"                   
#> [162] "freesurfer.mr_is_expand"                    
#> [163] "freesurfer.mr_is_inflate"                   
#> [164] "freesurfer.mri_convert"                     
#> [165] "freesurfer.mri_coreg"                       
#> [166] "freesurfer.mri_fill"                        
#> [167] "freesurfer.mri_marching_cubes"              
#> [168] "freesurfer.mri_pretess"                     
#> [169] "freesurfer.mri_tessellate"                  
#> [170] "freesurfer.mris_preproc_recon_all"          
#> [171] "freesurfer.mris_preproc"                    
#> [172] "freesurfer.mrtm1"                           
#> [173] "freesurfer.mrtm2"                           
#> [174] "freesurfer.ms_lda"                          
#> [175] "freesurfer.normalize"                       
#> [176] "freesurfer.one_sample_t_test"               
#> [177] "freesurfer.paint"                           
#> [178] "freesurfer.parcellation_stats"              
#> [179] "freesurfer.parse_dicom_dir"                 
#> [180] "freesurfer.recon_all"                       
#> [181] "freesurfer.register_av_ito_talairach"       
#> [182] "freesurfer.register"                        
#> [183] "freesurfer.relabel_hypointensities"         
#> [184] "freesurfer.remove_intersection"             
#> [185] "freesurfer.remove_neck"                     
#> [186] "freesurfer.resample"                        
#> [187] "freesurfer.robust_register"                 
#> [188] "freesurfer.robust_template"                 
#> [189] "freesurfer.sample_to_surface"               
#> [190] "freesurfer.seg_stats_recon_all"             
#> [191] "freesurfer.seg_stats"                       
#> [192] "freesurfer.segment_cc"                      
#> [193] "freesurfer.segment_wm"                      
#> [194] "freesurfer.smooth_tessellation"             
#> [195] "freesurfer.smooth"                          
#> [196] "freesurfer.sphere"                          
#> [197] "freesurfer.spherical_average"               
#> [198] "freesurfer.surface_smooth"                  
#> [199] "freesurfer.surface_snapshots"               
#> [200] "freesurfer.surface_transform"               
#> [201] "freesurfer.surface2_vol_transform"          
#> [202] "freesurfer.synthesize_flash"                
#> [203] "freesurfer.synthmorph_apply"                
#> [204] "freesurfer.synthmorph_register"             
#> [205] "freesurfer.synthstrip"                      
#> [206] "freesurfer.talairach_avi"                   
#> [207] "freesurfer.talairach_qc"                    
#> [208] "freesurfer.tkregister2"                     
#> [209] "freesurfer.unpack_sdicom_dir"               
#> [210] "freesurfer.volume_mask"                     
#> [211] "freesurfer.watershed_skull_strip"           
#> [212] "fsl.apply_mask"                             
#> [213] "fsl.apply_topup"                            
#> [214] "fsl.apply_warp"                             
#> [215] "fsl.apply_xfm"                              
...
#> [219] "fsl.bedpostx5"                              
#> [220] "fsl.bet"                                    
#> [221] "fsl.binary_maths"                           
#> [222] "fsl.change_data_type"                       
#> [223] "fsl.cluster"                                
#> [224] "fsl.complex"                                
#> [225] "fsl.contrast_mgr"                           
#> [226] "fsl.convert_warp"                           
#> [227] "fsl.convert_xfm"                            
#> [228] "fsl.copy_geom"                              
#> [229] "fsl.dilate_image"                           
#> [230] "fsl.distance_map"                           
#> [231] "fsl.dti_fit"                                
#> [232] "fsl.dual_regression"                        
#> [233] "fsl.eddy_correct"                           
#> [234] "fsl.eddy_quad"                              
#> [235] "fsl.eddy"                                   
#> [236] "fsl.epi_de_warp"                            
#> [237] "fsl.epi_reg"                                
...
#> [242] "fsl.feat"                                   
#> [243] "fsl.filmgls"                                
#> [244] "fsl.filter_regressor"                       
#> [245] "fsl.find_the_biggest"                       
#> [246] "fsl.first"                                  
#> [247] "fsl.flameo"                                 
#> [248] "fsl.flirt"                                  
#> [249] "fsl.fnirt"                                  
...
#> [252] "fsl.ica_aroma"                              
#> [253] "fsl.image_maths"                            
#> [254] "fsl.image_meants"                           
#> [255] "fsl.image_stats"                            
#> [256] "fsl.inv_warp"                               
#> [257] "fsl.isotropic_smooth"                       
#> [258] "fsl.make_dyadic_vectors"                    
#> [259] "fsl.maths_command"                          
#> [260] "fsl.max_image"                              
#> [261] "fsl.maxn_image"                             
#> [262] "fsl.mcflirt"                                
#> [263] "fsl.mean_image"                             
#> [264] "fsl.median_image"                           
#> [265] "fsl.melodic"                                
#> [266] "fsl.merge"                                  
#> [267] "fsl.min_image"                              
#> [268] "fsl.motion_outliers"                        
#> [269] "fsl.multi_image_maths"                      
#> [270] "fsl.overlay"                                
#> [271] "fsl.percentile_image"                       
#> [272] "fsl.plot_motion_params"                     
#> [273] "fsl.plot_time_series"                       
#> [274] "fsl.power_spectrum"                         
#> [275] "fsl.prelude"                                
#> [276] "fsl.prepare_fieldmap"                       
#> [277] "fsl.prob_track_x"                           
#> [278] "fsl.prob_track_x2"                          
#> [279] "fsl.proj_thresh"                            
#> [280] "fsl.randomise"                              
#> [281] "fsl.reorient2_std"                          
#> [282] "fsl.robust_fov"                             
#> [283] "fsl.sig_loss"                               
#> [284] "fsl.slice_timer"                            
#> [285] "fsl.slice"                                  
#> [286] "fsl.slicer"                                 
#> [287] "fsl.smm"                                    
#> [288] "fsl.smooth_estimate"                        
#> [289] "fsl.smooth"                                 
#> [290] "fsl.spatial_filter"                         
#> [291] "fsl.split"                                  
#> [292] "fsl.std_image"                              
#> [293] "fsl.susan"                                  
#> [294] "fsl.swap_dimensions"                        
#> [295] "fsl.temporal_filter"                        
#> [296] "fsl.text2_vest"                             
#> [297] "fsl.threshold"                              
#> [298] "fsl.topup"                                  
#> [299] "fsl.tract_skeleton"                         
#> [300] "fsl.unary_maths"                            
#> [301] "fsl.vec_reg"                                
#> [302] "fsl.vest2_text"                             
#> [303] "fsl.warp_points_from_std"                   
#> [304] "fsl.warp_points_to_std"                     
#> [305] "fsl.warp_points"                            
#> [306] "fsl.warp_utils"                             
#> [307] "fsl.x_fibres5"
```
...
Registration outputs carry explicit transform metadata: affine versus
warp or composite, the on-disk convention, and the source and target
image inputs. This lets niflowr load them as neurotransform morphisms
without guessing from an ambiguous `.mat` suffix:
...
ni_convert_transform(reg, "func2t1_itk.txt", format = "itk")
# Writes the same target-to-source mapping in ITK/ANTs LPS convention
```
